...
--------------------------------------------------------------------------------------------------------------
--- Mesclar consultas employee e departament para criar uma tabela employee com o nome dos departamentos associados 
--- aos colaboradores.
SELECT Fname AS 'Funcionário', Dname AS 'Departamento'
FROM employee E 
INNER JOIN departament D ON E.Ssn = D.Mgr_ssn;


--- Verifique o número de horas dos projetos
SELECT P.Pname AS 'Nome do Projeto', Hours AS 'Horas dos Projetos'
FROM works_on w
INNER JOIN project P ON P.Pnumber = W.Pno;

--- Realize a junção dos colaboradores e respectivos nomes dos gerentes.
SELECT Fname AS 'Funcionário', Dependent_name AS 'Gerente'
FROM employee E
